...
class TerarkDbCustomizationHooks {
public:
    static void set(ServiceContext* service,
                    std::unique_ptr<TerarkDbCustomizationHooks> custHooks);

    static TerarkDbCustomizationHooks* get(ServiceContext* service);

    virtual ~TerarkDbCustomizationHooks() = default;
    ...
    /**
     *  Gets the TerarkDb encryption configuration string for the
     *  provided table name
     */
...
// Empty default implementation of the abstract class TerarkDbCustomizationHooks
class EmptyTerarkDbCustomizationHooks : public TerarkDbCustomizationHooks {
public:
    ~EmptyTerarkDbCustomizationHooks() override;
