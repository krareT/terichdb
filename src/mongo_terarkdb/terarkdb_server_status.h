...
/**
 * Adds "terarkDb" to the results of db.serverStatus().
 */
class TerarkDbServerStatusSection : public ServerStatusSection {
public:
    TerarkDbServerStatusSection(TerarkDbKVEngine* engine);
