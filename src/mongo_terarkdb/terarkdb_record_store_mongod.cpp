...
class TerarkDbRecordStoreThread : public BackgroundJob {
public:
    TerarkDbRecordStoreThread(const NamespaceString& ns)
        : BackgroundJob(true /* deleteSelf */), _ns(ns) {
        _name = std::string("TerarkDb RecordStoreThread: ") + _ns.toString();
    }
    ...
    bool _deleteExcessDocuments() {
        ...
        checked_cast<TerarkDbRecoveryUnit*>(txn.recoveryUnit())->markNoTicketRequired();
        ...
        try {
            ...
            TerarkDbRecordStore* rs =
                checked_cast<TerarkDbRecordStore*>(collection->getRecordStore());
            ...
            severe() << "error in TerarkDbRecordStoreThread: " << e.what();
            fassertFailedNoTrace(!"error in TerarkDbRecordStoreThread");
        } catch (...) {
            fassertFailedNoTrace(!"unknown error in TerarkDbRecordStoreThread");
        }
        return true;
    }
