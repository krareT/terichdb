...
class TerarkDbRecordStore::OplogStones {
public:
    struct Stone {
    ...
    OplogStones(OperationContext* txn, TerarkDbRecordStore* rs);
    ...
    // efficiently truncate records with TerarkDb by skipping over tombstones, etc.
