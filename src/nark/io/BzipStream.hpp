/* vim: set tabstop=4 : */
#ifndef __nark_io_BzipStream_h__
#define __nark_io_BzipStream_h__
...
class NARK_DLL_EXPORT BzipInputStream	: public RefCounter, public IInputStream
{
...
class NARK_DLL_EXPORT BzipOutputStream : public RefCounter, public IOutputStream
{
