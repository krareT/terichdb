#ifndef __nark_io_var_int_inline_h__
...
#else
	if (nark_likely(!(x & 0xFFFF0000))) {
		if (nark_likely(!(x & 0xFF00))) {
			p[0] = (unsigned char)(x);
			return p + 1;
		}
		else {
...
unsigned char* gg_save_var_uint61(unsigned char* p, uint64_t x)
{
	...
	if (nark_likely(!(x & 0xFFFFFFFF00000000))) {
		if (nark_likely(!(x & 0xFFFF0000))) {
			if (nark_likely(!(x & 0xFF00))) {
				p[0] = (unsigned char)(x);
				return p + 1;
		...
		if (nark_likely(!(x & 0xFFFF000000000000))) {
			if (nark_likely(!(x & 0x0000FF0000000000))) {
			...
			if (nark_likely(!(x & 0xFF00000000000000))) {
...
#endif // __nark_io_var_int_inline_h__
