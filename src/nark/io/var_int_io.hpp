...
{
	if (nark_likely(this->buf_remain_bytes() >= 5))
	{
...
{
	if (nark_likely(this->buf_remain_bytes() >= 10))
	{
...
{
	if (nark_likely(this->buf_remain_bytes() >= 4))
	{
...
{
	if (nark_likely(this->buf_remain_bytes() >= 8))
	{
