/* vim: set tabstop=4 : */
#ifndef __nark_io_DataIO_Polymorphic_h__
#define __nark_io_DataIO_Polymorphic_h__
...
#define DATA_IO_POLYM_LOAD_EX(Input,Class)	\
	nark::serialization::polymorphic::InputImplement<Input, Class> \
...
#endif // __nark_io_DataIO_Polymorphic_h__
