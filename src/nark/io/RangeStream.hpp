#pragma once
#ifndef __nark_io_stream_range_hpp__
#define __nark_io_stream_range_hpp__
...
namespace nark {
	...
	public:
		...
		void read_string(std::string& s) {
			size_t len = NARK_IF_WORD_BITS_64(read_var_uint64, read_var_uint32)();
			s.resize(len);
			if (len)
...
#endif __nark_io_stream_range_hpp__
