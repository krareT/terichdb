/* vim: set tabstop=4 : */
#ifndef __nark_pipeline_hpp__
#define __nark_pipeline_hpp__
...
namespace nark {
	...
	#define NarkFuncBind boost::bind
#else
	using std::thread;
	using std::mutex;
	using std::function;
...
#define PPL_STEP_0(pObject, Class, MemFun, thread_count) \
	new nark::FunPipelineStage(thread_count\
		, NarkFuncBind(&Class::MemFun, pObject, _1, _2, _3)\
...
#define PPL_STEP_1(pObject, Class, MemFun, thread_count, arg1) \
	new nark::FunPipelineStage(thread_count\
		, NarkFuncBind(&Class::MemFun, pObject, _1, _2, _3, arg1)\
		, BOOST_STRINGIZE(Class::MemFun)\
		)
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#define PPL_STEP_2(pObject, Class, MemFun, thread_count, arg1, arg2) \
	new nark::FunPipelineStage(thread_count\
		, NarkFuncBind(&Class::MemFun, pObject, _1, _2, _3, arg1, arg2)\
		, BOOST_STRINGIZE(Class::MemFun)\
		)
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#define PPL_STEP_3(pObject, Class, MemFun, thread_count, arg1, arg2, arg3) \
	new nark::FunPipelineStage(thread_count\
		, NarkFuncBind(&Class::MemFun, pObject, _1, _2, _3, arg1, arg2, arg3)\
		, BOOST_STRINGIZE(Class::MemFun)\
		)
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
