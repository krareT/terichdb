...
public:
    ...
    void set0(size_t i) {
        assert(i < m_size);
		nark_bit_set0(m_words, i);
    }
    void set1(size_t i) {
        assert(i < m_size);
		nark_bit_set1(m_words, i);
    }
	...
	static bool fast_is1(const bm_uint_t* bits, size_t i) { return  nark_bit_test(bits, i); }
	static bool fast_is0(const bm_uint_t* bits, size_t i) { return !nark_bit_test(bits, i); }
};
