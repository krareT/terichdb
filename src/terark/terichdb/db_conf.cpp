...
//#define TERICHDB_DEDUCE_DATETIME_COLUMN
#ifdef TERICHDB_DEDUCE_DATETIME_COLUMN
#include <re2/re2.h>
#endif
...
TERICHDB_DLL llong parseSizeValue(fstring str) {
	char* endp = NULL;
