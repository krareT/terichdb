...
class TERARK_DB_DLL RandomReadAppendonlyStore final : public ReadableStore, public AppendableStore {
public:
...
class TERARK_DB_DLL SeqReadAppendonlyStore final : public ReadableStore, public AppendableStore {
