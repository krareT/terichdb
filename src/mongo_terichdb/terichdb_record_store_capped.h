...
class TerichDbKVEngine;

class TerichDbRecordStoreCapped : public RecordStore {
public:
    TerichDbRecordStoreCapped(OperationContext* ctx,
							StringData ns,
							StringData uri,
    ...
    virtual ~TerichDbRecordStoreCapped();
