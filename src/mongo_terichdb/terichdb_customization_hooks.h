...
class TerichDbCustomizationHooks {
public:
    static void set(ServiceContext* service,
                    std::unique_ptr<TerichDbCustomizationHooks> custHooks);

    static TerichDbCustomizationHooks* get(ServiceContext* service);

    virtual ~TerichDbCustomizationHooks() = default;
    ...
    /**
     *  Gets the TerichDb encryption configuration string for the
     *  provided table name
     */
...
// Empty default implementation of the abstract class TerichDbCustomizationHooks
class EmptyTerichDbCustomizationHooks : public TerichDbCustomizationHooks {
public:
    ~EmptyTerichDbCustomizationHooks() override;
