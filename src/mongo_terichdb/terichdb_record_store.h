...
class TerichDbRecordStore : public RecordStore {
public:
    TerichDbRecordStore(OperationContext* txn,
					  StringData ns,
					  StringData ident,
					  ThreadSafeTable* tab,
					  TerichDbSizeStorer* sizeStorer);

    virtual ~TerichDbRecordStore();
...
*/
    ...
    void setSizeStorer(TerichDbSizeStorer* ss) {
        //_sizeStorer = ss;
    }
...
// TerichDb failpoint to throw write conflict exceptions randomly
MONGO_FP_FORWARD_DECLARE(TerichDbWriteConflictException);
