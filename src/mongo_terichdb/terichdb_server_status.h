...
/**
 * Adds "terichDb" to the results of db.serverStatus().
 */
class TerichDbServerStatusSection : public ServerStatusSection {
public:
    TerichDbServerStatusSection(TerichDbKVEngine* engine);
