...
class TerichDbRecordStore::OplogStones {
public:
    struct Stone {
    ...
    OplogStones(OperationContext* txn, TerichDbRecordStore* rs);
    ...
    // efficiently truncate records with TerichDb by skipping over tombstones, etc.
