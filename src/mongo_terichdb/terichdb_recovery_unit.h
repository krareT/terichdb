...
class TerichDbRecoveryUnit final : public RecoveryUnit {
public:
    TerichDbRecoveryUnit();

    virtual ~TerichDbRecoveryUnit();
    ...
    static TerichDbRecoveryUnit* get(OperationContext* txn);
     ...
     *
     * Begins a TerichDb transaction, and invariants if we are already in one.
