...
class NarkDbCustomizationHooks {
public:
    static void set(ServiceContext* service,
                    std::unique_ptr<NarkDbCustomizationHooks> custHooks);

    static NarkDbCustomizationHooks* get(ServiceContext* service);

    virtual ~NarkDbCustomizationHooks() = default;
    ...
    /**
     *  Gets the NarkDb encryption configuration string for the
     *  provided table name
     */
...
// Empty default implementation of the abstract class NarkDbCustomizationHooks
class EmptyNarkDbCustomizationHooks : public NarkDbCustomizationHooks {
public:
    ~EmptyNarkDbCustomizationHooks() override;
