...
class NarkDbRecordStore::OplogStones {
public:
    struct Stone {
    ...
    OplogStones(OperationContext* txn, NarkDbRecordStore* rs);
    ...
    // efficiently truncate records with NarkDb by skipping over tombstones, etc.
