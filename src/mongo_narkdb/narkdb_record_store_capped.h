...
class NarkDbRecordStoreCapped : public RecordStore {
public:
    NarkDbRecordStoreCapped(OperationContext* ctx,
							StringData ns,
							StringData uri,
    ...
    virtual ~NarkDbRecordStoreCapped();
...
// NarkDb failpoint to throw write conflict exceptions randomly
MONGO_FP_FORWARD_DECLARE(NarkDbWriteConflictException);
