...
// This file is generated by terark-db-schema-compile.exe
...
namespace DbTest {
  ...
  struct TestRow {
    std::uint64_t id;
    terark::db::Schema::Fixed<19> fix;
    terark::db::Schema::Fixed<19> fix2;
    std::string str0;
    std::string str1;
    std::string str2;
    std::string str3;
  ...
  // var 'tab' must be a 'DbTablePtr', can not be a 'DbTable*'
  inline bool
  TestRow::checkTableSchema(terark::db::DbTablePtr& tab, bool checkColname) {
    using namespace terark::db;
