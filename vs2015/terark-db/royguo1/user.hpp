...
// This file is generated by C:\osc\terark-db\vs2015\terark-db\x64\Debug\terark-db-schema-compile.exe
...
namespace test_ns {
 ...
 // so we static assert sizeof(T)==fixlen here:
  ...
  // var 'tab' must be a 'DbTablePtr', can not be a 'DbTable*'
  inline bool
  User::checkTableSchema(terark::db::DbTablePtr& tab, bool checkColname) {
    using namespace terark::db;
